<template>
  <div class="home-product-swiper swiper-container" @mousemove="slideWithMouse">
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide" v-for="(item, index) in datasets" :key="index">
...
// 查看对应的视频
const showVideo = () => {
  // console.log(props.datasets[swiper.activeIndex].videosrc);
  pageStore.isShowVideo = props.datasets[swiper.activeIndex].videosrc
